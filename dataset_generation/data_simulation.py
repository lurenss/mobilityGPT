...
landuse_gdf = gpd.read_file('dataset_generation/shp_padova/landuse.shp')
...
buildings_gdf = gpd.read_file('dataset_generation/shp_padova/buildings.shp')
...
df.to_parquet('./gps_traces.parquet')